    ...
    <section class="p-1 p-sm-3 p-md-4 p-lg-5 mt-2 mt-lg-0">
        <div class="container">
            <div class="row text-center g-3">
                <?php
                $products = $productDB->getAllByCategory('chinese');
                        ...
                        <div class="card bg-dark text-light">
                            <div class="card-body text-center">
                                ...
                                <form method="post">
                                    ...
                                    <a href="checkout.php"><button class="btn btn-warning">In Winkelmandje</button></a>
                                </form>
                            </div>
                        </div>
                    </div>
